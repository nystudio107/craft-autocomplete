...
> Craft [3.7.8](https://github.com/craftcms/cms/blob/develop/CHANGELOG.md#378---2021-08-06) added autocompletion for Craft’s global Twig variables, however, this does not include autocomplete support for plugins and modules.
...
This worked on principles very similar to how Craft Autocomplete works, but it was a manual process. Ben & Andrew thought we could do better.

### Bootstrapping Yii2 Extension

This package is a Yii extension (and a module) that [bootstraps itself](https://www.yiiframework.com/doc/guide/2.0/en/structure-extensions#bootstrapping-classes).
...
All Craft Autocomplete does is generate source code files, very similar to how Craft itself generates a [CustomFieldBehavior](https://github.com/craftcms/cms/blob/develop/src/Craft.php#L232) class in `storage/runtime/compiled_classes`
 ...
 * @property \craft\web\twig\variables\EmailMessages $emailMessages
 * @property \craft\web\twig\variables\UserGroups $userGroups
 * @property \craft\web\twig\variables\UserPermissions $userPermissions
 ...
 * @property \nystudio107\retour\variables\RetourVariable $retour
 * @property \nystudio107\typogrify\variables\TypogrifyVariable $typogrify
 * @property \nystudio107\twigpack\variables\ManifestVariable $twigpack
 * @property \nystudio107\webperf\variables\WebperfVariable $webperf
 * @property \nystudio107\instantanalytics\variables\InstantAnalyticsVariable $instantAnalytics
 * @property \nystudio107\richvariables\variables\RichVariablesVariable $richVariables
 * @property \nystudio107\vite\variables\ViteVariable $vite
 * @property \nystudio107\youtubeliveembed\variables\YoutubeLiveEmbedVariable $youtubelive
 */
...
### The Symfony Plugin for PhpStorm
